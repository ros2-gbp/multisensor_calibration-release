...
#include "multisensor_calibration/ui/ExtrinsicLidarReferenceConfigWidget.h"
...
void ExtrinsicLidarReferenceConfigWidget::setTopicList(std::map<std::string, std::vector<std::string>> topicList)
{
