...
ref_lidar_sensor_name = LaunchConfiguration("ref_lidar_sensor_name")
ref_lidar_cloud_topic = LaunchConfiguration("ref_lidar_cloud_topic")
...
launch_params = [
    ...
    DeclareLaunchArgument(
        ...
        default_value="ouster_right",
    ),
    DeclareLaunchArgument(
        name="src_lidar_cloud_topic",
        default_value="/ouster_right_raw_pcl/cloud",
    ),
    DeclareLaunchArgument(
        name="ref_lidar_sensor_name",
        default_value="ouster_left",
    ),
    DeclareLaunchArgument(
        name="ref_lidar_cloud_topic",
...
def generate_launch_description():
    node = Node(
        ...
        # name=PythonExpression(["'", src_lidar_sensor_name, "_", ref_lidar_sensor_name, "_calibration'"]),
        ...
        parameters=[
            {
                ...
                "ref_lidar_sensor_name": ref_lidar_sensor_name,
                "ref_lidar_cloud_topic": ref_lidar_cloud_topic,
